...
namespace eBarbershop.Services.Migrations
{
    ...
    [Migration("20250810114518_listacekanja_diplomski")]
    partial class listacekanja_diplomski
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eBarbershop.Services.Database.ListaCekanja", b =>
                {
                    b.Property<int>("ListaCekanjaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ListaCekanjaId"));
                    ...
                    b.Property<bool>("NotifikacijaPoslana")
                        .HasColumnType("bit");
                    ...
                    b.Property<DateTime>("ZeljeniDatum")
                        .HasColumnType("datetime2");

                    b.Property<TimeSpan?>("ZeljenoVrijeme")
                        .HasColumnType("time");

                    b.HasKey("ListaCekanjaId");
            ...
            modelBuilder.Entity("eBarbershop.Services.Database.NotifikacijaListeCekanja", b =>
                {
                    ...
                    b.Property<string>("PorukaNofitikacije")
                        .IsRequired()
                        .HasMaxLength(1000)
                    ...
                    b.HasIndex("ListaCekanjaId");

                    b.HasIndex("TerminId");

                    b.ToTable("NotifikacijaListeCekanja");
                });
            ...
            modelBuilder.Entity("eBarbershop.Services.Database.PredvidjanjeZauzetosti", b =>
                {
                    b.Property<int>("PredvidjanjeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("PredvidjanjeId"));
                    ...
                    b.Property<string>("PreporuceniTermini")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<double>("UkupnaZauzetost")
                        .HasColumnType("float");

                    b.HasKey("PredvidjanjeId");

                    b.ToTable("PredvidjanjeZauzetosti");
                });

            modelBuilder.Entity("eBarbershop.Services.Database.PreporukaTermina", b =>
                {
                    ...
                    b.Property<DateTime>("PreporuceniTermin")
                        .HasColumnType("datetime2");

                    b.Property<string>("RazlogPreporuke")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<double>("SkorPovjerenja")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("eBarbershop.Services.Database.ZauzetostPoSatu", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PredvidjanjeId");

                    b.ToTable("ZauzetostPoSatu");
                });
            ...
            modelBuilder.Entity("eBarbershop.Services.Database.ListaCekanja", b =>
                {
                    b.HasOne("eBarbershop.Services.Database.Korisnik", "Frizer")
                        .WithMany()
            ...
            modelBuilder.Entity("eBarbershop.Services.Database.NotifikacijaListeCekanja", b =>
                {
                    b.HasOne("eBarbershop.Services.Database.ListaCekanja", "ListaCekanja")
                        .WithMany()
                        .HasForeignKey("ListaCekanjaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("eBarbershop.Services.Database.ZauzetostPoSatu", b =>
                {
                    b.HasOne("eBarbershop.Services.Database.PredvidjanjeZauzetosti", "Predvidjanje")
                        .WithMany("ZauzetostPoSatima")
                        .HasForeignKey("PredvidjanjeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Predvidjanje");
                });
            ...
            modelBuilder.Entity("eBarbershop.Services.Database.PredvidjanjeZauzetosti", b =>
                {
                    b.Navigation("ZauzetostPoSatima");
                });
